...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_BASE] = LAYOUT_maltron_8x16(
        ...
        KC_NO, 	    KC_5,    KC_4,    KC_3,    KC_2,    KC_1,   KC_QUOT, OSM(MOD_LCTL), KC_DEL,   KC_NO,   KC_NO,         KC_HOME, KC_PGUP, KC_INS,   KC_PAUS,  KC_PEQL, // ROW 3
        KC_NUBS,    KC_Q,    KC_B,    KC_P,    KC_M,    KC_G,   KC_X,    SW_LALT, 	KC_BSPC,  KC_UP,   KC_LGUI,       KC_END,  KC_PGDN, KC_DEL,   KC_BSPC,  KC_PPLS, // ROW 4
        KC_MINS,    KC_R,    KC_L,    KC_O,    KC_D,    KC_F,   KC_J,    KC_NO,   	KC_RGHT,  KC_DOWN, KC_LEFT,       KC_PSLS, KC_P9,   KC_P8,    KC_P7,    KC_PENT, // ROW 5
